...
@property(nonnull, nonatomic, copy) NSString *did;         //摄像机的sn
@property(nonnull, nonatomic, copy) NSString *device_token;   //用来校验sn
...
@property (nonatomic, assign) BOOL isSupportP2p;
 ...
 * 开始播放，可以切换新的摄像头
 */
- (void)startWithCameraInfo:(QHCamBaseInfo *_Nonnull)cameraInfo;
 ...
 * type: 录像类型测试 type=1 录像没有声音， type=3 录像有声音
 */
- (void)startRecordWith:(int)type callBack:(nonnull VideoRecordStatusCallBack)callBack;
